...
const stop_origin = {
  key: 'stop_origin',
  title: 'Origine',
  description: "Origine de l'arrêt",
  type: 'string'
}

const stop_destination = {
  key: 'stop_destination',
  title: 'Destination',
...
const week = {
  key: 'week',
  title: 'Semaine',
  description: 'Jours de la semaine où le trajet est disponible',
  type: 'string',
  separator: ';'
}
...
const end_date = {
  key: 'end_date',
  title: 'Fin période',
  description: 'Date de fin de disponibilité du trajet',
  type: 'string'
}
...
const start_date = {
  key: 'start_date',
  title: 'Début période',
  description: 'Date de début de disponibilité du trajet',
  type: 'string'
}
...
const route_color = {
  ...
  type: 'string',
  'x-refersTo': 'https://schema.org/color'
}
...
const stop_sequence = {
  key: 'stop_sequence',
  title: 'Séquence arrêt',
  description: "Séquence de l'arrêt, station, entrée/sortie, noeud générique ou zone d'embarquement",
  type: 'integer',
  ignoreDetection: true
}
...
exports.schemas = {
  stop_times: [trip_id, arrival_time, departure_time, stop_id, stop_name, stop_sequence, stop_origin, stop_destination, route_name, week, start_date, end_date, stop_lat, stop_lon, location_type, wheelchair_boarding, pickup_type, drop_off_type],
  ...
  stops: [geometry, stop_id, stop_code, stop_name, stop_desc, zone_id, stop_url, routes, location_type, parent_station, stop_timezone, wheelchair_boarding]
}
